...
dictionary_letter = {'AEIOULNSTRАВЕИНОРСТ': 1, 
             'DGДКЛМПУ': 2,
             'BCMPБГЁЬЯ': 3,
             'FHVWYЙЫ': 4,
             'KЖЗХЦЧ': 5,
...
for letter in word.upper():
    for letters in dictionary_letter.keys():
        if letter in letters:
            score_counter += dictionary_letter.get(letters)
            break
print(f'Ценность слова {score_counter} очков')